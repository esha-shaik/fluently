  ...
  return (
    <div className="flex-1 p-2 sm:p-4 flex flex-col min-h-0 space-y-0 pb-28 bg-gradient-to-br from-purple-100 via-blue-50 to-blue-200 min-h-screen">
      ...
      <div className="flex flex-col flex-shrink-0">
        {/* Translation Box */}
        <div className="bg-white rounded-3xl shadow-xl p-4 sm:p-8 mb-2 flex flex-col border border-blue-100 animate-fade-in transition-all duration-300 w-full md:w-4/5 lg:w-3/5 mx-auto" style={{ flex: '0 0 auto' }}>
          {/* Language Selection */}
          <div className="flex items-center justify-between mb-2">
            <div className="relative w-full">
              ...
              >
                ...
                {fromLanguages.filter(lang => lang !== "auto").map((lang) => (
            ...
            <button
              ...
              className="p-1.5 sm:p-2 text-purple-500 hover:bg-purple-100 rounded-lg transition-colors border border-purple-100 shadow-sm mx-1 sm:mx-2"
          ...
          <div className="relative mb-3 sm:mb-4">
            <textarea
              ...
              className="w-full p-3 sm:p-4 border-2 border-purple-200 rounded-2xl resize-none h-12 sm:h-14 outline-none focus:border-purple-300 focus:ring-2 focus:ring-purple-200 transition-all duration-200 shadow bg-purple-50 text-gray-800 hide-scrollbar"
            />
          </div>
          ...
          {showTranslationResult && translatedText && typeof translatedText === 'object' && !translatedText.error && (
            <div
              className="relative bg-gradient-to-r from-blue-50 to-purple-100 rounded-2xl p-4 sm:p-7 shadow-xl border border-blue-100 flex flex-col gap-3 sm:gap-4 transition-all duration-500 animate-fade-in"
            ...
            >
              ...
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                ...
                <span className="text-lg sm:text-2xl font-extrabold text-blue-800 bg-blue-100/60 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl shadow-sm">{translatedText.translation}</span>
              ...
              {translatedText.example_usage && (
                <div className="flex items-center gap-2 text-blue-700 text-sm sm:text-base italic mt-2"><span>📖</span><span>{translatedText.example_usage}</span></div>
              )}
        ...
        <div className="block md:hidden bg-white rounded-3xl shadow-xl p-4 sm:p-8 flex-1 flex flex-col min-h-0 mt-4 sm:mt-6 border border-blue-100 animate-fade-in transition-all duration-300 w-full mx-auto">
          <h3 className="text-xl sm:text-2xl font-bold text-blue-700 mb-3 sm:mb-5 tracking-tight">
            Recent Translations
          </h3>
          <div className="space-y-2 sm:space-y-3 flex-1 min-h-0">
            {translationHistory.map((item) => (
              <div key={item.id} className="p-2 sm:p-3 bg-gray-50 rounded-lg border border-gray-100">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-sm text-gray-500">
                    {item.from} → {item.to}
                  </span>
